...
- In case that the template is a Nodejs template, modify `<repo-root>/.scripts/generate-templates-matrix.js`, append the template name inside `nodeJsTemplates` list for automatic testing.
